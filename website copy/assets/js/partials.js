...
(function () {
  ...
  // Real coat-of-arms (inline copy of /assets/images/coat-of-arms.svg for SSR-less rendering)
  const COAT = `<img src="assets/images/coat-of-arms.svg" alt="Coat of Arms of the Federal Republic of Nigeria" width="52" height="52" />`;
  const COAT_FOOTER = `<img src="assets/images/coat-of-arms.svg" alt="" width="52" height="52" style="filter:brightness(1.15) drop-shadow(0 0 12px rgba(184,146,60,.18));" />`;
  ...
  <nav class="navbar" aria-label="Primary">
    <div class="container nav-inner">
      ...
      <button class="mobile-toggle" aria-label="Menu" aria-expanded="false">Menu</button>
